...
export default function AddCpgs() {
  const [file, setFile] = useState();
    ...
    const handleUpload = async () => {
        if (file) {
            ...
            try {
                const response = await axios.post('http://127.0.0.1:8000/add-cpgs/', formData, {
                    headers: {
  ...
  return (
    <div className='py-3'>
      ...
      <div className='text-center upload-container mb-2'>
        <a href="http://127.0.0.1:8000/download-cpgs-template/" download>
